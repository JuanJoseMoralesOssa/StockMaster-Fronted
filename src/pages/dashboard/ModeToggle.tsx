...
function ModeToggleDashboard(
  ...
  const buttonBase =
    'flex flex-1 sm:flex-none items-center justify-center gap-1.75 rounded-md px-4.5 py-2 [@media(pointer:coarse)]:py-2.5 text-sm font-semibold transition-all focus:outline-none focus-visible:ring-1 focus-visible:ring-(--color-focus-ring)'
