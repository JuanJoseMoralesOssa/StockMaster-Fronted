...
function SummaryTypeToggle({ value, onChange }: Readonly<SummaryTypeToggleProps>) {
  const buttonBase =
    'flex-1 sm:flex-none rounded-md px-3.5 py-1.5 [@media(pointer:coarse)]:py-2.5 text-sm font-semibold transition-all focus:outline-none focus-visible:ring-1 focus-visible:ring-(--color-focus-ring)'
