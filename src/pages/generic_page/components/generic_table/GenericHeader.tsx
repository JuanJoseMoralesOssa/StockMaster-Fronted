...
function GenericHeaderInner<T>({
  ...
  return (
    <section className='flex w-full flex-col gap-4 rounded-lg border border-(--view-accent-border,var(--color-border)) bg-(--view-accent-soft,var(--color-bg-surface)) px-4 py-4 pl-16 shadow-xs sm:flex-row sm:items-center sm:justify-between md:px-5'>
